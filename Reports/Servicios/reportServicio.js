  ...
  static async getInformeLetras(){
    ...
    try {
      ...
      const [result] = await conn.query(`
        SELECT tb1.proveedor,MONTH(tb1.fec_emision) as mes,tb1.documentos_ref,tb1.num_letra,tb1.fec_emision,tb1.fec_vencimiento ,IF(tb1.moneda = 'MN',tb1.importe,0) AS importe_soles,IF(tb1.moneda = 'USD',tb1.importe,0) AS importe_dolares,GROUP_CONCAT(CONCAT(IF(tda.tipodoc = 1,'FT','NC'),tda.serie,'-',tda.numero)) as facturas_ref
