import { conn_jsjfact } from "../../Main/utils.js";
export class ProduccionModel {
  static async getOrdenes(user_data) {
    ...
    try {
      ...
      // conn_jsjfact.releaseConnection(conn)
      console.log("MOstrando total ordenes:",results[0])
      return results
    } catch (err) {
      console.log(err);
      return {'msg':err}
  ...
  static async getOrdenesById(info) {
    ...
    try {
      ...
      console.log("Busqueda por id orden :",results)
      return results
    } catch (err) {
